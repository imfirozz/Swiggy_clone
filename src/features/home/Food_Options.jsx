...
export default function Food_Options() {
  ...
  return (
    <section className="w-full">
      <h2 className="text-[rgba(2,6,12,0.92)] text-[22px] sm:text-[24px] lg:text-[26px] font-bold pt-10 sm:pt-14 lg:pt-20 px-4 sm:px-6 lg:px-10">
        Order our best food options
      </h2>

      <div className="w-[92%] sm:w-[90%] mx-auto mt-6 sm:mt-8 lg:mt-10 overflow-x-auto scrollbar-hide">
